...
public class EAtoUppaal {
	...
	public static void main(String[] args) throws Exception {
		...
		ArrayList<TimingLifeline> allLifelines = new ArrayList<TimingLifeline>(); //存储所有lifeline
		ArrayList<connector> allConnectors = new ArrayList<connector>();			//存储所有message
		ArrayList<WJDiagramsData> diagramsDatas = new ArrayList<WJDiagramsData>();
		...
		for(WJDiagramsData diagramsData : diagramsDatas) {//遍历一张图
			...
			ArrayList<TimingLifeline> Lifelines = new ArrayList<TimingLifeline>(); //存储这张图lifeline
			ArrayList<connector> Connectors = new ArrayList<connector>();			//存储这张图message
			
			for(TimingLifeline lifeline : allLifelines) {//获得本图的lifeline
				if (diagramsData.ids.contains(lifeline.LifelineID)) {
					Lifelines.add(lifeline);
				}
			}
			
			for(connector con :allConnectors) {//获得本图的消息
